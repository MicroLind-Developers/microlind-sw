# Code Mode Guidelines for µLind Project

This document provides specific guidance for AI assistants operating in Code mode for the µLind project.
...
When working in Code mode, focus on:
- Writing clean, efficient assembly code following established patterns
- Implementing syscalls according to the defined ABI
- Ensuring proper register management and stack handling
- Following the existing code style and naming conventions
- Writing robust error handling code
- Implementing hardware drivers with proper initialization sequences
- Creating testable code with clear interfaces
- Maintaining compatibility with existing BIOS/MLOS interfaces
- Optimizing for the target embedded hardware constraints